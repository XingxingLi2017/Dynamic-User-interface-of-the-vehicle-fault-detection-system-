...
public class odometer {
	public void getDial(double rev) throws IOException
	{
		...
		// 设置显示在表盘中央位置的信息
		DialTextAnnotation dialtextannotation = new DialTextAnnotation("累计里程表");
        ...
        double endPosition=2000D; //开度 4000
        double skipValue=200D; //间隔 40
